...
"""assert_array_equal : Raises an AssertionError if two array_like objects are not equal.
Given two array_like objects, check that the shape is equal and all elements of these objects are equal.

assert_array_almost_equal : Raises an AssertionError if two objects are not equal up to desired precision (for floating point).
"""
